	...
	<div class="row"> <!-- Row 1 starts -->
		<div class="col-lg-12"> <!-- To make website responsive -->
			<ol class="breadcrumb"> <!-- To create horizontal navigation bar -->
				<li class="active">
					<i class="fa fa-dashboard"></i> Dashboard / Reports / Bad Feedback Report
				</li>
			</ol>
		</div>
	</div>
			...
			<div class="panel panel-default"> <!-- To colour the style of the panel  -->
				<div class="panel-heading"> <!-- To create a padding box around the heading of the coupon panel -->
					<h3 class="panel-title">
						<i class="fa fa-print"></i> Bad Feedback Report
					</h3>
				</div>	
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a href="index.php?bad_feedback" type="button" class="btn btn-success">Refresh</a>
                                        </div>
                                        <br>                              
                                    </div>
                            </form>
								...
								<table class="table table-bordered table-hover table-striped" > <!-- To create table striped -->
                                    ...
                                    <?php
                                        if(isset ($_POST['filter'])){
                                            ...
                                            $i=0;
                                            $query=mysqli_query($con, "select * from `cust_feedbacks` t1 inner join pending_orders t2 on t1.invoice_no=t2.invoice_no inner join products t3 on t2.product_id=t3.product_id where date(`feedback_date`) between '$from_date' and '$to_date' and (feedback_rating='poor') order by feedback_date asc");
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <?php
                                                $query=mysqli_query($con, "select count(feedback_id) as sum from `cust_feedbacks` where date(`feedback_date`) between '$from_date' and '$to_date' and (feedback_rating='poor')");
                                                    while($fetch=mysqli_fetch_array($query)){
                                            ?>

                                            <td colspan = "6"> <b><?php echo "Number of Bad Feedbacks";?></b> </td>
                                    ...
                                    <?php
                                        ...
                                        //Refresh page
                                                    ...
                                                    $i=0;
                                                    $query=mysqli_query($con, "select * from `cust_feedbacks` t1 inner join pending_orders t2 on t1.invoice_no=t2.invoice_no inner join products t3 on t2.product_id=t3.product_id where (feedback_rating='poor') order by feedback_date asc");
                                                        while($fetch=mysqli_fetch_array($query)){
                                                            $i++;
                                    ?>
                                    ...
                                    ?>       
                                        ...
                                        <tr>
                                            <?php
                                                $query=mysqli_query($con, "select count(feedback_id) as sum from `cust_feedbacks` where (feedback_rating='poor')");
                                                    while($fetch=mysqli_fetch_array($query)){
                                            ?>
